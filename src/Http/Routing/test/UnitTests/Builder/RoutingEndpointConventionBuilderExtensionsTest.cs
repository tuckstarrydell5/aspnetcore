...
public class RoutingEndpointConventionBuilderExtensionsTest
{
    ...
    [Fact]
    public void FinalConventions_CanExamineMetadataInLIFOOrder()
    {
        // Arrange
        var builder = CreateBuilder();
    ...
    private class DefaultEndpointConventionBuilder : IEndpointConventionBuilder
    {
        ...
        private List<Action<EndpointBuilder>> _finalConventions;
        ...
        public Endpoint Build()
        {
            ...
            var finalConventions = Interlocked.Exchange(ref _finalConventions, null);
            if (finalConventions is not null)
            {
                for (var i = finalConventions.Count - 1; i >= 0; i--)
                {
                    finalConventions[i](EndpointBuilder);
                }
            }
