...
public sealed class RouteGroupBuilder : IEndpointRouteBuilder, IEndpointConventionBuilder
{
    ...
    private readonly List<Action<EndpointBuilder>> _finalConventions = new();
    ...
    void IEndpointConventionBuilder.Finally(Action<EndpointBuilder> finalConvention) => _finalConventions.Add(finalConvention);
    ...
    private sealed class GroupEndpointDataSource : EndpointDataSource, IDisposable
    {
        ...
        public override IReadOnlyList<Endpoint> GetGroupedEndpoints(RouteGroupContext context) =>
            GetGroupedEndpointsWithNullablePrefix(context.Prefix, context.Conventions, context.FinalConventions, context.ApplicationServices);
            ...
            IServiceProvider applicationServices)
        {
            return _routeGroupBuilder._dataSources.Count switch
            {
                ...
                1 => _routeGroupBuilder._dataSources[0].GetGroupedEndpoints(GetNextRouteGroupContext(prefix, conventions, finalConventions, applicationServices)),
                _ => SelectEndpointsFromAllDataSources(GetNextRouteGroupContext(prefix, conventions, finalConventions, applicationServices)),
            };
        }
            ...
            IServiceProvider applicationServices)
        {
            ...
            var combinedFinalConventions = RoutePatternFactory.CombineLists(finalConventions, _routeGroupBuilder._finalConventions);
            return new RouteGroupContext
            {
                Prefix = fullPrefix,
                Conventions = combinedConventions,
                FinalConventions= combinedFinalConventions,
