...
internal abstract class ActionEndpointDataSourceBase : EndpointDataSource, IDisposable
{
    ...
    protected readonly List<Action<EndpointBuilder>> FinalConventions;
    ...
    public ActionEndpointDataSourceBase(IActionDescriptorCollectionProvider actions)
    {
        ...
        FinalConventions = new List<Action<EndpointBuilder>>();
    }
    ...
    private void UpdateEndpoints()
    {
        lock (Lock)
        {
            var endpoints = CreateEndpoints(
                ...
                groupFinalConventions: Array.Empty<Action<EndpointBuilder>>());
