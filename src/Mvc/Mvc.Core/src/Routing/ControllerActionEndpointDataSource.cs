...
internal sealed class ControllerActionEndpointDataSource : ActionEndpointDataSourceBase
{
        ...
        : base(actions)
    {
        ...
        DefaultBuilder = new ControllerActionEndpointConventionBuilder(Lock, Conventions, FinalConventions);
        ...
        RouteValueDictionary? dataTokens)
    {
        lock (Lock)
        {
            ...
            var finalConventions = new List<Action<EndpointBuilder>>();
            _routes.Add(new ConventionalRouteEntry(routeName, pattern, defaults, constraints, dataTokens, _orderSequence.GetNext(), conventions, finalConventions));
            return new ControllerActionEndpointConventionBuilder(Lock, conventions, finalConventions);
        }
    }
