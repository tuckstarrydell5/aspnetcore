...
public class ActionEndpointFactoryTest
{
    ...
    public void RequestDelegateFactoryWorks()
    {
        ...
        factory.AddEndpoints(
            ...
            finalConventions: Array.Empty<Action<EndpointBuilder>>(),
    ...
    private ConventionalRouteEntry CreateRoute(
        ...
        List<Action<EndpointBuilder>> finalConventions = null)
    {
        conventions ??= new List<Action<EndpointBuilder>>();
        finalConventions ??= new List<Action<EndpointBuilder>>();
        return new ConventionalRouteEntry(routeName, pattern, defaults, constraints, dataTokens, order, conventions, finalConventions);
    }
